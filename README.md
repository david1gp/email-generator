...
## Markdown Template (`markdownV1`)

The `/renderEmailTemplate/markdownV1` endpoint renders Markdown content into HTML and plain text email formats.
...
- The `markdown` field is limited to 1,000 characters.
- Request body size limit: 32,768 bytes (returns 413 if exceeded).
...
| **invoiceV1** - Invoice (paid / unpaid variants)<br>![invoiceV1](https://f003.backblazeb2.com/file/email-generator-images/invoiceV1.jpg)           | **markdownV1** - Markdown<br>![markdownV1](https://f003.backblazeb2.com/file/email-generator-images/markdownV1.jpg)                           |
